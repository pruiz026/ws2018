    ...
    <head> 
        ...
        <link rel='stylesheet' 
       	...
       	<script type="text/javascript" lenguage="javascript">
			...
			{
				<?php
					echo "xhro.open('GET','showXMLQuestions.php?user=".$_GET['logged']."', true);";
				?>
				xhro.send()	
			}
		</script>
						...
						{				
							...
							else 
							{
								...
								if(!$xml)
								{
									...
									echo "<p><a href='handlingQuizAJAX.php'> Sartu galdera berri bat </a>";
								}
	...
	<body>
	    <div id='page-wrap'>
			...
			<section class="main" id="s1">
				<div>
				<form id="formularioa" name="formularioa" action="handlingQuizAJAX.php?logged=$id" method="post" enctype='multipart/form-data'>
					...
					<br/><br/>
					<a href='<?php $id=$_GET['logged']; echo "layout.php?logged=$id";?>'>ATZERA</a>
				</form>
				</div>
			</section>
