		...
		<div id='page-wrap'>
			...
			<section class="main" id="s1">
				...
				<form id="formularioa" action="signUp.php" method="post" enctype="multipart/form-data">
					Eposta (*): <input type="text" class="input" name="eposta" size="50" required pattern="^([a-z]{2,})([0-9]{3})@ikasle\.ehu\.eus$" value="xxxx000@ikasle.ehu.eus"/> <br><br>
					Deitura (*): <input type="text" class="input" name="deitura" size="50" required pattern="^([A-Z]{1}[a-z]+\s)([A-Z]{1}[a-z]+(\s)?)+$"/> <br><br>
					Pasahitza (*): <input type="password" class="input" name="pasahitza" size="50" required pattern="^.{8,}$"/> <br><br>
					Pasahitza errepikatu (*): <input type="password" class="input" name="pasahitzaErrepikatu" size="50" required pattern="^.{8,}$"/> <br><br>
